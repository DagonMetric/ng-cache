...
2. Fork the [repo](https://github.com/dagonmetric/ng-cache) and create your branch `topic` from master.
...
8. In GitHub, submit a pull request to [dagonmetric/ng-cache](https://github.com/dagonmetric/ng-cache).
